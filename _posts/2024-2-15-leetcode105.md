...
<br>
Inorder sequence illustrates the nodes of the subtree associated with a given node. 
<br>
&emsp;(1) The left subsequence in the inorder sequence from the start to the given node represents the left subtree. 
<br>
&emsp;(2) The right subsequence in the inorder sequence from the given node to the end represents the right subtree.
</p>
<br>
